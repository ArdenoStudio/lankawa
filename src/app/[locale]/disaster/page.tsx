    ...
    <div className="space-y-6">
      ...
      <IrrigationGaugesPanel
        ...
        labels={{
          ...
          rainWatchTitle: t("irrigation.rainWatchTitle"),
          rainHeavyChip: t.raw("irrigation.rainHeavyChip"),
          rainMore: t.raw("irrigation.rainMore"),
          rainNote: t("irrigation.rainNote"),
