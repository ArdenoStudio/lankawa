"""Minimal unofficial HTTP client for GDACS + NASA FIRMS.
...
DEFAULT_UA = "gdacs-firms-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/gdacs-firms-docs; educational; polite)"
DEFAULT_BASE = ""


class GdacsFirmsDocsClient:
    """Unofficial client — GDACS + NASA FIRMS."""
    ...
    def __enter__(self) -> "GdacsFirmsDocsClient":
        return self
    ...
    def gdacs_events_rss(self, **kwargs: Any) -> Any:
    ...
    def firms_csv_lk(self, **kwargs: Any) -> Any:
