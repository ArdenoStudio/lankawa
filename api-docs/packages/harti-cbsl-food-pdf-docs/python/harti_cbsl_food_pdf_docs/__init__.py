"""Minimal unofficial HTTP client for HARTI + CBSL Food Price PDFs.
...
DEFAULT_UA = "harti-cbsl-food-pdf-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/harti-cbsl-food-pdf-docs; educational; polite)"
DEFAULT_BASE = ""


class HartiCbslFoodPdfDocsClient:
    """Unofficial client — HARTI + CBSL Food Price PDFs."""
    ...
    def __enter__(self) -> "HartiCbslFoodPdfDocsClient":
        return self
    ...
    def harti_daily_prices_index(self, **kwargs: Any) -> Any:
    ...
    def cbsl_weekly_food(self, **kwargs: Any) -> Any:
...
from .models import PageResult, FoodPrice
