"""Minimal unofficial HTTP client for Pan Asia Bank Card Offers.
...
DEFAULT_UA = "pabc-card-offers-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/pabc-card-offers-docs; educational; polite)"
DEFAULT_BASE = "https://www.pabc.com"


class PabcCardOffersDocsClient:
    """Unofficial client — Pan Asia Bank Card Offers."""
    ...
    def __enter__(self) -> "PabcCardOffersDocsClient":
        return self
    ...
    def card_offers_js(self, **kwargs: Any) -> Any:
        """Offers page; arr_offers JS after Sucuri cookie.

        Catalog id: `card_offers_js` · GET
        """
        url = "https://www.pabc.com/personal/cards/offers"
        payload: Any = None
        return self._request_json(url, method='GET', **kwargs)

    def senior_fd_html(self, **kwargs: Any) -> Any:
        """Senior FD HTML (main ladder may be PDF-only).

        Catalog id: `senior_fd_html` · GET
        """
...
__all__ = ["PabcCardOffersDocsClient"]
