"""Minimal unofficial HTTP client for Litro + LAUGFS LPG price pages.
...
DEFAULT_UA = "litro-laugfs-lpg-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/litro-laugfs-lpg-docs; educational; polite)"
DEFAULT_BASE = ""


class LitroLaugfsLpgDocsClient:
    """Unofficial client — Litro + LAUGFS LPG price pages."""
    ...
    def __enter__(self) -> "LitroLaugfsLpgDocsClient":
        return self
    ...
    def litro_prices(self, **kwargs: Any) -> Any:
    ...
    def laugfs_prices(self, **kwargs: Any) -> Any:
