"""Minimal unofficial HTTP client for Met Dept CAP / Advisories.
...
DEFAULT_UA = "metdept-cap-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/metdept-cap-api-docs; educational; polite)"
DEFAULT_BASE = "https://was.meteo.gov.lk"


class MetdeptCapApiDocsClient:
    """Unofficial client — Met Dept CAP / Advisories."""
    ...
    def __enter__(self) -> "MetdeptCapApiDocsClient":
        return self
    ...
    def cap_en_rss(self, **kwargs: Any) -> Any:
    ...
    def cap_si_rss(self, **kwargs: Any) -> Any:
    ...
    def cap_ta_rss(self, **kwargs: Any) -> Any:
        """CAP Tamil warnings.
...
__all__ = ["MetdeptCapApiDocsClient"]
