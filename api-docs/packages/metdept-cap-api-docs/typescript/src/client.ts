/**
 * Unofficial TypeScript client — Met Dept CAP / Advisories
 *
...
export class MetdeptCapApiDocsClient {
  ...
  static readonly slug = "metdept-cap-api-docs";
  static readonly title = "Met Dept CAP / Advisories";
   ...
   * Catalog id: `cap_en_rss` · GET
   */
  async capEnRss(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.meteo.gov.lk/images/XML/cap_en.xml", options.query), { ...options, method: "GET" });
  }

  /**
   * CAP Sinhala warnings.
   * Catalog id: `cap_si_rss` · GET
   */
  async capSiRss(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.meteo.gov.lk/images/XML/cap_si.xml", options.query), { ...options, method: "GET" });
  }

  /**
   * CAP Tamil warnings.
   * Catalog id: `cap_ta_rss` · GET
   */
  async capTaRss(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.meteo.gov.lk/images/XML/cap_ta.xml", options.query), { ...options, method: "GET" });
  }
}
