"""Minimal unofficial HTTP client for CEB Care API.
...
DEFAULT_UA = "cebcare-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/cebcare-api-docs; educational; polite)"
DEFAULT_BASE = "https://cebcare.ceb.lk"


class CebcareApiDocsClient:
    """Unofficial client — CEB Care API."""
    ...
    def __enter__(self) -> "CebcareApiDocsClient":
        return self
    ...
    def demand_mgmt_schedule(self, **kwargs: Any) -> Any:
    ...
    def get_demand_mgmt_clusters(self, group_id: str = "A", **kwargs: Any) -> Any:
        """Clusters for group A–Y; requires verification token.

        Catalog id: `get_demand_mgmt_clusters` · GET
        """
        url = self._with_query("https://cebcare.ceb.lk/Incognito/GetDemandMgmtClusters?LoadShedGroupId=A", {'LoadShedGroupId': group_id})
        payload: Any = None
        return self._request_json(url, method='GET', **kwargs)


__all__ = ["CebcareApiDocsClient"]
