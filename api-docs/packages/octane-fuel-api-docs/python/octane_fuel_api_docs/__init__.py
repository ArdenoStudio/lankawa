"""Minimal unofficial HTTP client for Octane Fuel API.
...
DEFAULT_UA = "octane-fuel-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/octane-fuel-api-docs; educational; polite)"
DEFAULT_BASE = "https://octane-api.fly.dev"


class OctaneFuelApiDocsClient:
    """Unofficial client — Octane Fuel API."""
    ...
    def __enter__(self) -> "OctaneFuelApiDocsClient":
        return self
    ...
    def prices_latest(self, **kwargs: Any) -> Any:
        """Latest fuel prices.
    ...
    def comparison_world(self, **kwargs: Any) -> Any:
        """World pump compare.
...
__all__ = ["OctaneFuelApiDocsClient"]
