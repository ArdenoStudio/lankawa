/**
 * Unofficial TypeScript client — Octane Fuel API
 *
...
export class OctaneFuelApiDocsClient {
  ...
  static readonly slug = "octane-fuel-api-docs";
  static readonly title = "Octane Fuel API";
  ...
  /**
   * Latest fuel prices.
   * Catalog id: `prices_latest` · GET
   */
  async pricesLatest(options: RequestOptions = {}): Promise<unknown> {
  ...
  /**
   * World pump compare.
   * Catalog id: `comparison_world` · GET
   */
  async comparisonWorld(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://octane-api.fly.dev/v1/comparison/world", options.query), { ...options, method: "GET" });
  }
}
