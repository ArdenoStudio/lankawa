/**
 * Unofficial JavaScript (ESM) client — NTB Mastercard + Amex Offers
...
export class NtbAmexOffersDocsClient {
  ...
  static slug = "ntb-amex-offers-docs";
  static title = "NTB Mastercard + Amex Offers";
  ...
  async ntbPromotionsHub(options = {}) {
    return this.requestJson(this.resolveUrl("https://www.ntb.lk/personal/cards/promotions", options.query), { ...options, method: "GET" });
  }

  /** Amex LK supermarket offers HTML. */
  async amexSupermarketOffers(options = {}) {
    return this.requestJson(this.resolveUrl("https://www.americanexpress.lk/en-lk/benefits/consumer/supermarket-offers/", options.query), { ...options, method: "GET" });
  }
}
