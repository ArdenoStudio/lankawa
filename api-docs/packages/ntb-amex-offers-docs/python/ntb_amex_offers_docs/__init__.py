"""Minimal unofficial HTTP client for NTB Mastercard + Amex Offers.
...
DEFAULT_UA = "ntb-amex-offers-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/ntb-amex-offers-docs; educational; polite)"
DEFAULT_BASE = ""


class NtbAmexOffersDocsClient:
    """Unofficial client — NTB Mastercard + Amex Offers."""
    ...
    def __enter__(self) -> "NtbAmexOffersDocsClient":
        return self
    ...
    def ntb_promotions_hub(self, **kwargs: Any) -> Any:
    ...
    def amex_supermarket_offers(self, **kwargs: Any) -> Any:
...
__all__ = ["NtbAmexOffersDocsClient"]
