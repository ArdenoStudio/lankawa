# HTML scrape vs API — `ntb-amex-offers-docs`

**NTB Mastercard + Amex Offers** · Tier B
...
|---|---|---|---|---|
| `ntb_promotions_hub` | `html_scrape` | GET | `/personal/cards/promotions` | NTB card promotions hub HTML. |
| `amex_supermarket_offers` | `html_scrape` | GET | `/benefits/consumer/supermarket-offers/` | Amex LK supermarket offers HTML. |
