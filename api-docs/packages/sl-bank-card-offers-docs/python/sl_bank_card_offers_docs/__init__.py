"""Minimal unofficial HTTP client for SL Bank Supermarket Card Offers.
...
DEFAULT_UA = "sl-bank-card-offers-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/sl-bank-card-offers-docs; educational; polite)"
DEFAULT_BASE = ""


class SlBankCardOffersDocsClient:
    """Unofficial client — SL Bank Supermarket Card Offers."""
    ...
    def __enter__(self) -> "SlBankCardOffersDocsClient":
        return self
