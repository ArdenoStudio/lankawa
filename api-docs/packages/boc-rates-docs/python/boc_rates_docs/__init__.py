"""Minimal unofficial HTTP client for Bank of Ceylon Rates.
...
DEFAULT_UA = "boc-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/boc-rates-docs; educational; polite)"
DEFAULT_BASE = "https://www.boc.lk"


class BocRatesDocsClient:
    """Unofficial client — Bank of Ceylon Rates."""
    ...
    def __enter__(self) -> "BocRatesDocsClient":
        return self
    ...
    def rates_tariff_html(self, **kwargs: Any) -> Any:
        """Canonical FX + FD HTML — prefer over stale JSON.

        Catalog id: `rates_tariff_html` · GET
        """
        url = "https://www.boc.lk/rates-tariff"
        payload: Any = None
        return self._request_json(url, method='GET', **kwargs)

    def interest_rates_fd_json_parked(self, **kwargs: Any) -> None:
        """PARK — live JSON but wrong vs rates-tariff HTML.
