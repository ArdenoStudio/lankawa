/**
 * Unofficial TypeScript client — Bank of Ceylon Rates
 *
...
export class BocRatesDocsClient {
  ...
  static readonly slug = "boc-rates-docs";
  static readonly title = "Bank of Ceylon Rates";
   ...
   */
  async ratesTariffHtml(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.boc.lk/rates-tariff", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async interestRatesFdJsonParked(options: RequestOptions = {}): Promise<never> {
    void options;
