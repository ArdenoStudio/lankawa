...
This package currently lives inside the Lankawa monorepo at `api-docs/packages/peoples-bank-rates-docs/`.
**Extract to** public repo `Cookie-Cat21/peoples-bank-rates-docs` using [`api-docs/EXTRACTION_PROMPT.md`](../../EXTRACTION_PROMPT.md).
...
```bash
cd api-docs/packages/peoples-bank-rates-docs
