"""Minimal unofficial HTTP client for Amana / Union / Cargills Bank rates & offers.
...
DEFAULT_UA = "amana-union-cargills-bank-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/amana-union-cargills-bank-docs; educational; polite)"
DEFAULT_BASE = ""


class AmanaUnionCargillsBankDocsClient:
    """Unofficial client — Amana / Union / Cargills Bank rates & offers."""
    ...
    def __enter__(self) -> "AmanaUnionCargillsBankDocsClient":
        return self
...
__all__ = ["AmanaUnionCargillsBankDocsClient"]
