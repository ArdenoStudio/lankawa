"""Minimal unofficial HTTP client for Softlogic EMI (park — heavy crawl).
...
DEFAULT_UA = "softlogic-emi-park-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/softlogic-emi-park-docs; educational; polite)"
DEFAULT_BASE = "https://www.softlogic.lk"


class SoftlogicEmiParkDocsClient:
    """Unofficial client — Softlogic EMI (park — heavy crawl)."""
    ...
    def __enter__(self) -> "SoftlogicEmiParkDocsClient":
        return self
    ...
    def variation_detail_parked(self, **kwargs: Any) -> None:
