...
This package currently lives inside the Lankawa monorepo at `api-docs/packages/nwsdb-bill-api-docs/`.
**Extract to** public repo `Cookie-Cat21/nwsdb-bill-api-docs` using [`api-docs/EXTRACTION_PROMPT.md`](../../EXTRACTION_PROMPT.md).
...
```bash
cd api-docs/packages/nwsdb-bill-api-docs
