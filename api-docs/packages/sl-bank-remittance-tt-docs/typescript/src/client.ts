/**
 * Unofficial TypeScript client — SL Bank Remittance TT Rates
 *
...
const DEFAULT_UA = "sl-bank-remittance-tt-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/sl-bank-remittance-tt-docs; educational; polite)";

function sleep(ms: number): Promise<void> {
  return new Promise((resolve) => setTimeout(resolve, ms));
}

export class SlBankRemittanceTtDocsClient {
  ...
  static readonly slug = "sl-bank-remittance-tt-docs";
  static readonly title = "SL Bank Remittance TT Rates";
  ...
  /**
   * Aggregator: ComBank/Sampath/HNB/Seylan/NSB/DFCC/BOC/People's/NDB TT boards.
...
export default SlBankRemittanceTtDocsClient;
