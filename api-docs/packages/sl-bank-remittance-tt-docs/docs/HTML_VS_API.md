# HTML scrape vs API — `sl-bank-remittance-tt-docs`

**SL Bank Remittance TT Rates** · Tier B
...
|---|---|---|---|---|
| `pack_overview` | `json_api` | GET | `(multi-host pack)` | Aggregator: ComBank/Sampath/HNB/Seylan/NSB/DFCC/BOC/People's/NDB TT boards. |
