"""Minimal unofficial HTTP client for SL Bank Remittance TT Rates.
...
DEFAULT_UA = "sl-bank-remittance-tt-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/sl-bank-remittance-tt-docs; educational; polite)"
DEFAULT_BASE = ""


class SlBankRemittanceTtDocsClient:
    """Unofficial client — SL Bank Remittance TT Rates."""
    ...
    def __enter__(self) -> "SlBankRemittanceTtDocsClient":
        return self
    ...
    def pack_overview(self, **kwargs: Any) -> Any:
...
from .models import PageResult, FxTtQuote
