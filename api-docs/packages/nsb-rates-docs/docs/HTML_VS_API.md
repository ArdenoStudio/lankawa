# HTML scrape vs API — `nsb-rates-docs`

**NSB Rates Pages** · Tier B
...
|---|---|---|---|---|
| `deposit_rates_html` | `html_scrape` | GET | `/rates-tarriffs/deposit-rates/` | Deposit rates HTML (note path typo tarriffs). |
| `exchange_rates_html` | `html_scrape` | GET | `/rates-tarriffs/exchange-rates/` | FX TT HTML board. |
