/**
 * Unofficial JavaScript (ESM) client — NSB Rates Pages
...
export class NsbRatesDocsClient {
  ...
  static slug = "nsb-rates-docs";
  static title = "NSB Rates Pages";
  ...
  async depositRatesHtml(options = {}) {
    return this.requestJson(this.resolveUrl("https://www.nsb.lk/rates-tarriffs/deposit-rates/", options.query), { ...options, method: "GET" });
  }

  /** FX TT HTML board. */
  async exchangeRatesHtml(options = {}) {
    return this.requestJson(this.resolveUrl("https://www.nsb.lk/rates-tarriffs/exchange-rates/", options.query), { ...options, method: "GET" });
  }
}
