"""Minimal unofficial HTTP client for Singer Sri Lanka EMI API.
...
DEFAULT_UA = "singer-emi-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/singer-emi-api-docs; educational; polite)"
DEFAULT_BASE = "https://www.singersl.com"


class SingerEmiApiDocsClient:
    """Unofficial client — Singer Sri Lanka EMI API."""
    ...
    def __enter__(self) -> "SingerEmiApiDocsClient":
        return self
    ...
    def json_get_emi(self, **kwargs: Any) -> Any:
...
__all__ = ["SingerEmiApiDocsClient"]
