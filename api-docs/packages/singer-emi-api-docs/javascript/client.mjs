/**
 * Unofficial JavaScript (ESM) client — Singer Sri Lanka EMI API
...
export class SingerEmiApiDocsClient {
  ...
  static slug = "singer-emi-api-docs";
  static title = "Singer Sri Lanka EMI API";
  ...
  async jsonGetEmi(options = {}) {
    return this.requestJson(this.resolveUrl("https://www.singersl.com/json-get-emi?product_id=7884&product_price=53699", options.query), { ...options, method: "GET" });
  }
}
