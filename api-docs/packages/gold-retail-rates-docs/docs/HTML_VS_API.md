# HTML scrape vs API — `gold-retail-rates-docs`

**Gold retail rates research pack** · Tier B
...
|---|---|---|---|---|
| `cbsl_gold_page` | `html_scrape` | GET | `(see GOLD_RETAIL_RATES_RESEARCH.md)` | CBSL + jeweller retail gold scrape notes. |
