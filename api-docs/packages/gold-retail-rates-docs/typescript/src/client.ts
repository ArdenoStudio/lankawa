/**
 * Unofficial TypeScript client — Gold retail rates research pack
 *
...
const DEFAULT_UA = "gold-retail-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/gold-retail-rates-docs; educational; polite)";

function sleep(ms: number): Promise<void> {
  return new Promise((resolve) => setTimeout(resolve, ms));
}

export class GoldRetailRatesDocsClient {
  ...
  static readonly slug = "gold-retail-rates-docs";
  static readonly title = "Gold retail rates research pack";
  ...
  /**
   * CBSL + jeweller retail gold scrape notes.
   * Catalog id: `cbsl_gold_page` · GET
   */
  async cbslGoldPage(options: RequestOptions = {}): Promise<unknown> {
...
export default GoldRetailRatesDocsClient;
