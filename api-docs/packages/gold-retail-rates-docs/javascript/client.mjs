/**
 * Unofficial JavaScript (ESM) client — Gold retail rates research pack
...
export class GoldRetailRatesDocsClient {
  ...
  static slug = "gold-retail-rates-docs";
  static title = "Gold retail rates research pack";
