"""Minimal unofficial HTTP client for Gold retail rates research pack.
...
DEFAULT_UA = "gold-retail-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/gold-retail-rates-docs; educational; polite)"
DEFAULT_BASE = ""


class GoldRetailRatesDocsClient:
    """Unofficial client — Gold retail rates research pack."""
    ...
    def __enter__(self) -> "GoldRetailRatesDocsClient":
        return self
    ...
    def cbsl_gold_page(self, **kwargs: Any) -> Any:
...
from .models import PageResult, MacroCbsl
