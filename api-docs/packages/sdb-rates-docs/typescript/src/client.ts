/**
 * Unofficial TypeScript client — SANASA Development Bank rates
 *
...
export class SdbRatesDocsClient {
  ...
  static readonly slug = "sdb-rates-docs";
  static readonly title = "SANASA Development Bank rates";
   ...
   */
  async ratesPage(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.sdb.lk/rates/", options.query), { ...options, method: "GET" });
  }
}
