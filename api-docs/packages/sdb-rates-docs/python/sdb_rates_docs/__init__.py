"""Minimal unofficial HTTP client for SANASA Development Bank rates.
...
DEFAULT_UA = "sdb-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/sdb-rates-docs; educational; polite)"
DEFAULT_BASE = "https://www.sdb.lk"


class SdbRatesDocsClient:
    """Unofficial client — SANASA Development Bank rates."""
    ...
    def __enter__(self) -> "SdbRatesDocsClient":
        return self
    ...
    def rates_page(self, **kwargs: Any) -> Any:
        """SDB rates HTML surfaces.

        Catalog id: `rates_page` · GET
        """
