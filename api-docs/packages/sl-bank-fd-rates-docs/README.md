...
This package currently lives inside the Lankawa monorepo at `api-docs/packages/sl-bank-fd-rates-docs/`.
**Extract to** public repo `Cookie-Cat21/sl-bank-fd-rates-docs` using [`api-docs/EXTRACTION_PROMPT.md`](../../EXTRACTION_PROMPT.md).
...
```bash
cd api-docs/packages/sl-bank-fd-rates-docs
