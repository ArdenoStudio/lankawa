"""Minimal unofficial HTTP client for SL Bank Fixed Deposit Rates.
...
DEFAULT_UA = "sl-bank-fd-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/sl-bank-fd-rates-docs; educational; polite)"
DEFAULT_BASE = ""


class SlBankFdRatesDocsClient:
    """Unofficial client — SL Bank Fixed Deposit Rates."""
    ...
    def __enter__(self) -> "SlBankFdRatesDocsClient":
        return self
