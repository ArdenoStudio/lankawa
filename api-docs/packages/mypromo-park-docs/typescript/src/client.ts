/**
 * Unofficial TypeScript client — MyPromo.lk (park — ToS)
 *
...
const DEFAULT_UA = "mypromo-park-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/mypromo-park-docs; educational; polite)";

function sleep(ms: number): Promise<void> {
  return new Promise((resolve) => setTimeout(resolve, ms));
}

export class MypromoParkDocsClient {
  ...
  constructor(options: ClientOptions = {}) {
    this.baseUrl = (options.baseUrl ?? "https://mypromo.lk").replace(/\/$/, "");
  ...
  static readonly slug = "mypromo-park-docs";
  static readonly title = "MyPromo.lk (park — ToS)";
  ...
  /**
   * PARK — ToS bans scrape; prefer bank first-party.
   * @remarks PARKED — see docs; method refuses live calls by default.
   */
  async mypromoParked(options: RequestOptions = {}): Promise<never> {
    void options;
    throw new Error("Parked endpoint: mypromo_parked (mypromo-park-docs)");
  }
}

export default MypromoParkDocsClient;
