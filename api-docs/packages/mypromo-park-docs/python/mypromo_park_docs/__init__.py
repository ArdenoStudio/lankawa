"""Minimal unofficial HTTP client for MyPromo.lk (park — ToS).
...
DEFAULT_UA = "mypromo-park-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/mypromo-park-docs; educational; polite)"
DEFAULT_BASE = "https://mypromo.lk"


class MypromoParkDocsClient:
    """Unofficial client — MyPromo.lk (park — ToS)."""
    ...
    def __enter__(self) -> "MypromoParkDocsClient":
        return self
    ...
    def mypromo_parked(self, **kwargs: Any) -> None:
