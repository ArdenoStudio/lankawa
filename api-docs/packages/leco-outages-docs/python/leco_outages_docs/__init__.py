"""Minimal unofficial HTTP client for LECO Outage Notices.
...
DEFAULT_UA = "leco-outages-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/leco-outages-docs; educational; polite)"
DEFAULT_BASE = "https://www.leco.lk"


class LecoOutagesDocsClient:
    """Unofficial client — LECO Outage Notices."""
    ...
    def __enter__(self) -> "LecoOutagesDocsClient":
        return self
    ...
    def interruption_notices(self, **kwargs: Any) -> Any:
        """LECO interruption notices HTML.

        Catalog id: `interruption_notices` · GET
        """
