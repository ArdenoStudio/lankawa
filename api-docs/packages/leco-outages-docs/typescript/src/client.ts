/**
 * Unofficial TypeScript client — LECO Outage Notices
 *
...
export class LecoOutagesDocsClient {
  ...
  static readonly slug = "leco-outages-docs";
  static readonly title = "LECO Outage Notices";
   ...
   */
  async interruptionNotices(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.leco.lk/pages_e.php?id=45", options.query), { ...options, method: "GET" });
  }
}
