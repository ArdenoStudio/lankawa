/**
 * Unofficial TypeScript client — Open-Meteo Sri Lanka Recipes
 *
...
export class OpenMeteoLkDocsClient {
  ...
  static readonly slug = "open-meteo-lk-docs";
  static readonly title = "Open-Meteo Sri Lanka Recipes";
   ...
   */
  async forecastColombo(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://api.open-meteo.com/v1/forecast?latitude=6.9271&longitude=79.8612&daily=uv_index_max,precipitation_sum&timezone=Asia%2FColombo", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async airQualityColombo(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://air-quality-api.open-meteo.com/v1/air-quality?latitude=6.9271&longitude=79.8612&hourly=pm2_5,us_aqi", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async marineColombo(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://marine-api.open-meteo.com/v1/marine?latitude=6.9271&longitude=79.8612&hourly=wave_height", options.query), { ...options, method: "GET" });
  }
}
