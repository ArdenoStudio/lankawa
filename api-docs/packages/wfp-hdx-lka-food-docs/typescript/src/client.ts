/**
 * Unofficial TypeScript client — WFP HDX Sri Lanka Food Prices
 *
...
export class WfpHdxLkaFoodDocsClient {
  ...
  static readonly slug = "wfp-hdx-lka-food-docs";
  static readonly title = "WFP HDX Sri Lanka Food Prices";
   ...
   * Catalog id: `wfp_food_prices_lka_csv` · GET
   */
  async wfpFoodPricesLkaCsv(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://data.humdata.org/dataset/0298c598-d312-4771-b564-f4ac4d831f05/resource/3638f0d6-9969-48cf-a919-1d879d037ec6/download/wfp_food_prices_lka.csv", options.query), { ...options, method: "GET" });
  }
}
