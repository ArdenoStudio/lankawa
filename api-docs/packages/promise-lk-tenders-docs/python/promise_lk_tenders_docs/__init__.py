"""Minimal unofficial HTTP client for Promise.lk tenders.
...
DEFAULT_UA = "promise-lk-tenders-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/promise-lk-tenders-docs; educational; polite)"
DEFAULT_BASE = "https://promise.lk"


class PromiseLkTendersDocsClient:
    """Unofficial client — Promise.lk tenders."""
    ...
    def __enter__(self) -> "PromiseLkTendersDocsClient":
        return self
    ...
    def procurements_list(self, **kwargs: Any) -> Any:
...
from .models import PageResult, PlatformMisc
