...
**Tier:** A · **Category:** markets · **Status:** extend-existing

Deepen Cookie-Cat21/cse-api-docs with topGainers, topLooses, 52WeekSectors, company announcements, GICS valuations.
...
This package currently lives inside the Lankawa monorepo at `api-docs/packages/cse-api-docs-deepen/`.
**Extract to** public repo `Cookie-Cat21/cse-api-docs-deepen` using [`api-docs/EXTRACTION_PROMPT.md`](../../EXTRACTION_PROMPT.md).

## Source research (Lankawa)

- `docs/CSE_API_DOCS.md`
- `docs/CSE_UNUSED_ENDPOINTS_PROBE.md`
...
```bash
cd api-docs/packages/cse-api-docs-deepen
