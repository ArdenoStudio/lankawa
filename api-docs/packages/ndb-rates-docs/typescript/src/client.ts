/**
 * Unofficial TypeScript client — NDB Rates
 *
...
export class NdbRatesDocsClient {
  ...
  static readonly slug = "ndb-rates-docs";
  static readonly title = "NDB Rates";
  ...
  async exchangeRates(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.ndbbank.com/rates-and-tariffs/exchange-rates", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async depositInterest(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.ndbbank.com/rates-and-tariffs/interest-rates-for-deposits", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async cardOffers(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.ndbbank.com/cards/offers", options.query), { ...options, method: "GET" });
  }
}
