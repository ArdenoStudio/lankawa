# HTML scrape vs API — `ndb-rates-docs`
...
|---|---|---|---|---|
| `exchange_rates` | `html_scrape` | GET | `/rates-and-tariffs/exchange-rates` | FX rates HTML. |
| `deposit_interest` | `html_scrape` | GET | `/rates-and-tariffs/interest-rates-for-deposits` | Deposit interest HTML. |
| `card_offers` | `html_scrape` | GET | `/cards/offers` | Card offers HTML. |
