"""Minimal unofficial HTTP client for lk-flood-api (nuuuwan).
...
DEFAULT_UA = "lk-flood-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/lk-flood-api-docs; educational; polite)"
DEFAULT_BASE = "https://nuuuwan.github.io"


class LkFloodApiDocsClient:
    """Unofficial client — lk-flood-api (nuuuwan)."""
    ...
    def __enter__(self) -> "LkFloodApiDocsClient":
        return self
    ...
    def flood_latest(self, **kwargs: Any) -> Any:
        """Flood station levels JSON used by Lankawa flood adapter.

        Catalog id: `flood_latest` · GET
        """
