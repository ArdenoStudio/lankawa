...
This package currently lives inside the Lankawa monorepo at `api-docs/packages/dfcc-rates-docs/`.
**Extract to** public repo `Cookie-Cat21/dfcc-rates-docs` using [`api-docs/EXTRACTION_PROMPT.md`](../../EXTRACTION_PROMPT.md).
...
```bash
cd api-docs/packages/dfcc-rates-docs
